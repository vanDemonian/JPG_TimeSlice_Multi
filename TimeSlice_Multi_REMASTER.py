...
SliceCount = SC = 320 # produces a 6 pixel wide band
...
inputDir = '/Users/pyDev/Documents/JPG_TIMESLICERY/JPG_TimeSlice_Multi/input/LKWtest'
#inputDir = '/Users/marty/Documents/DTLA_Programming/JPG_REFINERY/JPG_PIXEL_TEST/input'
outputDir = '/Users/pyDev/Documents/JPG_TIMESLICERY/JPG_TimeSlice_Multi/output'
...
def renderAB(SliceObject):
	...
	BxF = [(ScreenWidth-speed), ScreenWidth]
	B.append(BxF)
	print
	...
	outpathName = outputDir  + '/' +  str(location) + "_" + str(fdt2) + "_to_" + str(ldt2) + "_" + str(outNum1).rjust(6).replace(' ','0') + '.jpg'
	...
	outpathName = outputDir  + '/' +  str(location) + "_" + str(fdt2) + "_to_" + str(ldt2) + "_" + str(outNum2).rjust(6).replace(' ','0') + '.jpg'
